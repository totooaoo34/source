...
/**
 * @author Administrator 布局静态数据适配器
 * 
 */
public class GuessMsgAdapte extends BaseAdapter {

	private List<GuessMsg> mMsgs;
	private Context mContext;

	public GuessMsgAdapte(Context context, List<GuessMsg> msgs) {
		mContext = context;
		mMsgs = msgs;
	}
	...
	public View getView(int position, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(mContext).inflate(R.layout.list_home,
					null);
			viewHolder.iv_like_img = (ImageView) view
					.findViewById(R.id.iv_like_img);
			viewHolder.tv_like_title = (TextView) view
					.findViewById(R.id.tv_like_title);
			;
			viewHolder.tv_like_conten = (TextView) view
					.findViewById(R.id.tv_like_conten);
			;
		...
		viewHolder.tv_like_conten.setText(msg.getGuessContent());
		return view;
	}
