package com.android.tenementclient.widget;
...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		//检索半径
		radius = a.getDimension(R.styleable.CircleFlowIndicator_m_centered, 4.0f);
		...
		mCentered = a.getBoolean(R.styleable.CircleFlowIndicator_m_centered,
				false);
