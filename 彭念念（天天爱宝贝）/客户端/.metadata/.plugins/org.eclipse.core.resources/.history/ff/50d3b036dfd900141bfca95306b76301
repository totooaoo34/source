...
public class SelectPicPopupWindow extends PopupWindow {
	...
	public SelectPicPopupWindow(Activity context, OnClickListener itemsOnClick) {
		...
		sendtext.setOnClickListener(itemsOnClick);
		sendimage.setOnClickListener(itemsOnClick);
		sendyuyin.setOnClickListener(itemsOnClick);
		sendtuya.setOnClickListener(itemsOnClick);
