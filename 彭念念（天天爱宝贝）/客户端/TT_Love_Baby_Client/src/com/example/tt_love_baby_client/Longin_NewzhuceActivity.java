...
public class Longin_NewzhuceActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		et_username =(EditText) findViewById(R.id.et_newusername);
		et_shouji =(EditText) findViewById(R.id.et_newshouji);
		et_pws =(EditText) findViewById(R.id.et_newpws);
		...
		bt_newuser_go.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(Longin_NewzhuceActivity.this,New_selectchenshiActivity.class);
			}
		});
	}
