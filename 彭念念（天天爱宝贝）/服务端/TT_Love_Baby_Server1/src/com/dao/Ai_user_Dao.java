...
public class Ai_user_Dao {
	...
	//修改用户密码
	public void updata_Ai_user(Ai_user user){
//		Session session = template.getSessionFactory().openSession();
//		//String hql = "update ai_user set user_phone='"+haoma+"' where user_id="+id;
//		session.update("user_phone", Ai_user.class, id);
//		session.close();
	...
	//号码查询
	public Ai_user findBy_Ai_userhaoma(String haoma){
		Session session = template.getSessionFactory().openSession();
